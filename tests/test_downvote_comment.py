"""
Tests for downvote_comment action - direct action testing without QueueProcessor.
"""
import time
import logging
import pytest
...
class TestDownvoteCommentDirect:
    """Tests for downvote_comment action - direct execution."""

    def test_downvote_comment_success(self, db_session):
        ...
        action = get_action_class("downvote_comment")(camofox)
    ...
    def test_downvote_comment_scenario_suspended(self, db_session):
    ...
    def test_downvote_comment_scenario_locked(self, db_session):
    ...
    def test_downvote_comment_scenario_rate_limited(self, db_session):
        """Test downvote comment with rate limited scenario."""
        from app.services.queue_actions import get_action_class

        logger.info(f"[TEST] Starting test_downvote_comment_scenario_rate_limited")
        ...
        logger.info(f"[TEST] ✅ PASSED: test_downvote_comment_scenario_rate_limited")
